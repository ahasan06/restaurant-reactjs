...
function Hero() {
  return (
    <section className=" max-w-[1373px] min-h-[790px] md:min-h-[750px]  xl:min-h-[850px]  2xl:min-h-[1000px] flex flex-col justify-between pt-28 lg:justify-normal px-6  pb-6 lg:pb-0 gap-6 mx-auto   md:relative  lg:flex-row  text-white ">

      <article className='flex flex-col gap-8 md:justify-center z-20  '>
      ...
      <aside className='relative lg:absolute right-0 lg:right-10  2xl:right-0 md:top-1/2 lg:-translate-y-1/2  lg:w-[45%] 2xl:w-auto '>

...
function Hero() {
  return (
    <section className=" max-w-[1373px] min-h-[790px] md:min-h-[750px]  xl:min-h-screen flex flex-col justify-between pt-32 lg:justify-normal px-6  pb-6 lg:pb-0 gap-6 mx-auto   md:relative  lg:flex-row  text-white ">
      ...
      <aside className='relative lg:absolute right-0 lg:right-10 2xl:right-0 md:top-1/2 lg:-translate-y-1/2  lg:w-[45%] xl:w-[40%] 2xl:w-auto '>

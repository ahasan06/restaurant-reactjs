...
function Hero() {
  return (
    <section className=" max-w-[1373px] min-h-[648px] 2xl:min-h-screen flex flex-col justify-center lg:justify-normal px-6 pb-6 lg:pb-0 gap-6 mx-auto   md:relative  lg:flex-row  text-white ">
      ...
      <aside className='relative lg:absolute right-0 md:top-1/2 lg:-translate-y-1/2  lg:w-[50%] xl:w-auto '>
        <img src={heroImage} alt="hero image" className="relative z-10 w-full " />
        <img src={offerIcon}  className='w-24 absolute bottom-0 right-0 -translate-y-0 z-20 lg:w-32 2xl:translate-x-1/2 2xl:translate-y-4'/>
